...
def rrtmg_tape5_writer_htr_lw_band(atm,wbroadl,nlev):
    ...
    record1  = rdef1(0,0,1,0,98,0,cflag,0,0,0,atm.sza,2,0,0,'0.162822 2046.2270',1,0,atm.semiss)
...
def rrtmg_lw_output_read_band(nlev):
    ...
    for j in range(0,nlev):
        ...
        fluxbroad.fdn[j] = tmp2[5]
        fluxbroad.fnt[j] = tmp2[6]
        fluxbroad.htr[j] = tmp2[7]
    ...
    for k in range(1,15):
        ...
        for j in range(0,nlev):
            ...
            fluxband.fdn_band[k-1,j] = tmp2[5]
            fluxband.fnt_band[k-1,j] = tmp2[6]
            fluxband.htr_band[k-1,j] = tmp2[7]
